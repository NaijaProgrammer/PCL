	...
	public function exec_code(){
   	...
   	public function set_options($config = array()){
    		...
    		$default_config = array(
      		...
      		foreach($config AS $key => $value){ //overwrite default configuration settings with the one provided by user
       			$default_config[$key] = $value;
      		}

      		foreach($default_config AS $key => $value){ // after copying config properties from the provided one, use them to set the flash variables
